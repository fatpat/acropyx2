      ...
      {value === index && (
        <Box sx={{ p: 3 }}>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} hidden={!displayPilotResume}>
              <Typography variant="h5">
                <IconButton aria-label='delete' onClick={event => hiddenPilotResume(event, 0)}>
                  <ArrowBackIcon />
                </IconButton>
                {children} for {rows[selectedPilotIndex].team.name}
              </Typography>
              <Stack direction="row">
                <Avatar
                  src={rows[selectedPilotIndex].team.pilots[0].photo}
                  sx={{
                    width: '5em',
                    height: '5em',
                ...
                />
                <Avatar
                  src={rows[selectedPilotIndex].team.pilots[1].photo}
                  sx={{
                    width: '5em',
                    height: '5em',
                    border: theme => `0.25rem solid ${theme.palette.common.white}`
              ...
              <ul hidden={rows[selectedPilotIndex].did_not_start}>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>Synchro: {rows[selectedPilotIndex].final_marks?.judges_mark?.synchro.toFixed(3).toLocaleString('en-US')}</li>
                  </ul>
                </li>
                <li>
                  Calculated Marks:
                  <ul>
                    ...
                    <li>Synchro: {rows[selectedPilotIndex].final_marks?.synchro.toFixed(3).toLocaleString('en-US')}</li>
                  </ul>
                </li>
